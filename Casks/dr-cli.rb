...
cask "dr-cli" do
  ...
  on_macos do
    on_intel do
      sha256 "b09c07e3197065b6eafc7718879124202bc1b23ba9923e636eca523c19d40e44"
    ...
    on_arm do
      sha256 "fd67afaaf35b407d17761cdbd37742b90672cbfc61e4189c3fbf32ab7049aee4"
  ...
  on_linux do
    on_intel do
      sha256 "0378b31dfbcaaedcd198f371e065a8465691a82b93dec6586f177db309c0cf55"
      url "https://github.com/datarobot-oss/cli/releases/download/v#{version}/dr_v#{version}_Linux_x86_64.tar.gz",
        verified: "github.com/datarobot-oss/cli/"
    end
    on_arm do
      sha256 "131850ad8d848b851c828d96c75413679a5fb755c09bcd11d2b32a646dc6f4f1"
