...
cask "dr-cli" do
  ...
  on_macos do
    on_intel do
      sha256 "c7bfb181c109052239806141378b5d109a06b7ecc47fc8bc5d19324eae3edfbd"
    ...
    on_arm do
      sha256 "8d3f2319bb78f8dd54ce9b449fc90e34856584ef70a09252b9407d44c6e77699"
  ...
  on_linux do
    on_intel do
      sha256 "6e0c91bd2bc7812e5a752d210fd447505ccec9dee6e0b81e570219922b4cc49f"
      url "https://github.com/datarobot-oss/cli/releases/download/v#{version}/dr_v#{version}_Linux_x86_64.tar.gz",
        verified: "github.com/datarobot-oss/cli/"
    end
    on_arm do
      sha256 "3a42d2ff8f9274db5f21ba29c0c403a7dccad5984a622390bc1ddff71dbf9035"
